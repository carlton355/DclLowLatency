...
- The code in the Preview.html in the Kernel project needs a home. It needs to run in the context of the browser but we probably don't want to have it polluting the WebBrowser code.
