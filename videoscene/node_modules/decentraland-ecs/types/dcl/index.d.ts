...
declare class BasicMaterial extends ObservableComponent {
     ...
     */
    texture?: Texture | VideoTexture | AvatarTexture | VideoRealtimeTexture;
    /**
...
declare enum CLASS_ID {
    ...
    VIDEO_TEXTURE = 71,
    AVATAR_TEXTURE = 72,
    VIDEO_REALTIME_TEXTURE = 73,
    VIDEO_REALTIME_STREAM = 74,
    AUDIO_CLIP = 200,
    AUDIO_SOURCE = 201,
    AUDIO_STREAM = 202,
    GIZMOS = 203,
...
declare class Material extends ObservableComponent {
     ...
     */
    albedoTexture?: Texture | VideoTexture | AvatarTexture | VideoRealtimeTexture;
    /**
     * Texture applied as opacity. Default: the same texture used in albedoTexture.
     */
    alphaTexture?: Texture | VideoTexture | AvatarTexture | VideoRealtimeTexture;
    /**
     * Emissive texture.
     */
    emissiveTexture?: Texture | VideoTexture | AvatarTexture | VideoRealtimeTexture;
    /**
 ...
 * @public
 */
 declare class VideoRealtimeStream extends ObservableComponent {
    readonly url: string;
    readonly streamId: string;
    readonly provider: string;
    constructor(url: string, streamId: string, provider:string);
}
 ...
 * @public
 */
 declare class VideoRealtimeTexture extends ObservableComponent {
    readonly videoClipId: string;
    /**
     * Enables crisper images based on the provided sampling mode.
     * | Value | Type      |
     ...
     */
    playing: boolean;
    constructor(videoClip: VideoRealtimeStream, opts?: Partial<Pick<VideoRealtimeTexture, 'samplingMode' | 'wrap'>>);
    play(): void;
    pause(): void;
    reset(): void;
    seekTime(seconds: number): void;
