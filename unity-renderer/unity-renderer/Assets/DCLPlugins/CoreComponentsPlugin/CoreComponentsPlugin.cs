...
public class CoreComponentsPlugin : IPlugin
{
    ...
    public CoreComponentsPlugin()
    {
        ...
        factory.RegisterBuilder((int) CLASS_ID.VIDEO_REALTIME_TEXTURE, BuildComponent<DCLVideoRealtimeTexture>);
        factory.RegisterBuilder((int) CLASS_ID.VIDEO_REALTIME_STREAM, BuildComponent<DCLVideoRealtimeStream>);
    ...
    public void Dispose()
    {
        ...
        factory.UnregisterBuilder((int) CLASS_ID.VIDEO_REALTIME_TEXTURE);
        factory.UnregisterBuilder((int) CLASS_ID.VIDEO_REALTIME_STREAM);
