...
namespace DCL.Interface
{
    ...
    public static System.Action<string, string> OnMessageFromEngine;
        ...
        [Serializable]
        public class SetupRealtimeVideoPayload
        {
        ...
        [Serializable]
        public class UnloadRealtimeVideoPayload
        {
            public string videoId;
        }
        ...
        public static void SetupRealtimeVideo(string url, string streamId, string provider, string videoId)
        {
            var setupRealtimeVideoPayload = new SetupRealtimeVideoPayload
            {
                url = url,
                streamId = streamId,
                provider = provider,
            ...
            SendMessage("SetupRealtimeVideo", setupRealtimeVideoPayload);
        }

        public static void UnloadRealtimeVideo(string videoId)
        {
            var unloadRealtimeVideoPayload = new UnloadRealtimeVideoPayload
            {
                videoId = videoId
            };
            SendMessage("UnloadRealtimeVideo", unloadRealtimeVideoPayload);
        }
