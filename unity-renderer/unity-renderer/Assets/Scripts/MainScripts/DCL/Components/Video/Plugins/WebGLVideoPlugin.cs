...
namespace DCL.Components.Video.Plugin
{
    public static class WebGLVideoPlugin
    {
        ...
        public static extern void WebVideoPlayerCreate(string id, string url, bool useHls, bool useRtc);
        [DllImport("__Internal")]
...
#else
        public static void WebVideoPlayerCreate(string id, string url, bool useHls, bool useRtc) { }
