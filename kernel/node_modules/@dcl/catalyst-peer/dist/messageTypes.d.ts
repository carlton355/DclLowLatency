export declare type TTLFunction = (index: number, type: PeerMessageType) => number;
export declare type OptimisticFunction = (index: number, type: PeerMessageType) => boolean;
export declare type PeerMessageType = {
    /**
...
export declare const PeerMessageTypes: {
...
export declare const PingMessageType: PeerMessageType;
export declare const PongMessageType: PeerMessageType;
export declare const SuspendRelayType: PeerMessageType;
