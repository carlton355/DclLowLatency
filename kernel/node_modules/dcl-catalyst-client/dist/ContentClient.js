...
class ContentClient {
    ...
    async deployEntity(deployData, _fix = false, options) {
        const { creationTimestamp } = (await this.deploy(deployData, options));
    ...
    onlyKnownHeaders(headersFromResponse) {
        ...
        headersFromResponse === null || headersFromResponse === void 0 ? void 0 : headersFromResponse.forEach((headerValue, headerName) => {
