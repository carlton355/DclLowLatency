...
import { Fetcher, RequestOptions, ServerStatus } from 'dcl-catalyst-commons';
...
export declare class ContentClient implements ContentAPI {
    ...
    deployEntity(deployData: DeploymentData, _fix?: boolean, options?: RequestOptions): Promise<number>;
    ...
    fetchAuditInfo(type: EntityType, id: string, options?: RequestOptions): Promise<any>;
    ...
    pipeContent(contentHash: string, writeTo: any, options?: Partial<RequestOptions>): Promise<Map<string, string>>;
