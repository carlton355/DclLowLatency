...
/// --- SIDE EFFECTS ---
{
    ...
    app.use('/@/artifacts/index.js', express.static((0, path_1.resolve)(__dirname, '../static/index.js'), {
        setHeaders: (res) => {
            res.setHeader('Content-Type', 'application/javascript');
        }
    }));
    app.use('/@/artifacts/unity-renderer', express.static(path.dirname(require.resolve('@dcl/unity-renderer'))));
    app.use('/default-profile', express.static((0, path_1.resolve)(__dirname, '../static/default-profile')));
    app.use('/preview.html', express.static((0, path_1.resolve)(__dirname, '../static/preview.html'), {
        setHeaders: (res) => {
            res.setHeader('Content-Type', 'text/html');
        }
    }));
    app.use('/index.html', express.static((0, path_1.resolve)(__dirname, '../static/index.html'), {
        setHeaders: (res) => {
            res.setHeader('Content-Type', 'text/html');
        }
    }));
    app.use('/test', express.static((0, path_1.resolve)(__dirname, '../test')));
    app.use('/node_modules', express.static((0, path_1.resolve)(__dirname, '../node_modules')));
