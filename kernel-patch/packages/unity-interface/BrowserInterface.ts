...
export class BrowserInterface {
  ...
  public SetupRealtimeVideo(setupRealtimeVideo:{
    provider: string
    url: string
    streamId: string
    videoId: string
  }){
    globalObservable.emit('loadRealtimeVideo', setupRealtimeVideo);
  }

  public UnloadRealtimeVideo(unloadRealtimeVideo:{
    videoId: string
  }){
    globalObservable.emit('unloadRealtimeVideo', unloadRealtimeVideo);
  }
